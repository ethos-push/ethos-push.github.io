              ...
              <div className="relative overflow-hidden px-10 my-4 py-6 rounded shadow-xl bg-white w-4/5 mx-auto">
                  ...
                  <div className="mt-2 text-justify">
                      <a className="text-2xl text-gray-700 hover:text-gray-600">
                          <strong>E</strong>mpa<strong>TH</strong>etic <strong>O</strong>rchestration of
                          <strong> S</strong>crutable <strong>Push</strong>
                      </a>
                      <p className="mt-4 text-gray-600">
                          Push-notifications 🔔 originated as a method of prompting desktop users to check their email 📧.
                          They are now used for a myriad of uses, most common of which is to inform subscribers of new
                          information. In recent years, notifications have expanded across devices (such as mobile 📱 and IoTs) and
                          applications (they are no longer exclusively used by email clients). The result: we are interrupted
                          and distracted now, more than ever 🥴.
                      </p>
                      <p className="mt-4 text-gray-600">
                          Academia 🎓 has identified the negative impacts of push-notifications and is working toward solutions 💡.
                          A barrier toward this research, however, is the availability of open, freely shareable notification data 📊 with
                          which to test hypotheses, develop/train algorithms 🧠 and compare/benchmark solutions.
                      </p>
                      <p className="mt-4 text-gray-600">
